...
#include "GoapCombatPlannerConfiguration.generated.h"

/**
 * Configuration for a GoapPlanner that handles combat actions (upper body).
 * Another configuration handles movement actions (lower body).
 */
UCLASS(BlueprintType, Blueprintable)
class GOAPSHOOTER_API UGoapCombatPlannerConfiguration : public UGoapPlannerConfiguration
{
    GENERATED_BODY()
    
public:
    UGoapCombatPlannerConfiguration();
